# camera-live-view - Task 2.6

Execute task 2.6 for the camera-live-view specification.

## Task Description
Add camera discovery endpoint to UniFiClient in `src/api/client.py`

## Usage
```
/Task:2.6-camera-live-view
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add camera discovery endpoint to UniFiClient in `src/api/client.py`"

```
Use the @spec-task-executor agent to implement task 2.6: "Add camera discovery endpoint to UniFiClient in `src/api/client.py`" for the camera-live-view specification and include all the below context.
...
## Task Details
- Task ID: 2.6
- Description: Add camera discovery endpoint to UniFiClient in `src/api/client.py`

## Instructions
- Implement ONLY task 2.6: "Add camera discovery endpoint to UniFiClient in `src/api/client.py`"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks camera-live-view 2.6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks camera-live-view 2.6 --mode complete
```

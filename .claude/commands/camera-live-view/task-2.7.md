# camera-live-view - Task 2.7

Execute task 2.7 for the camera-live-view specification.

## Task Description
Add stream URL endpoint to UniFiClient in `src/api/client.py`

## Usage
```
/Task:2.7-camera-live-view
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add stream URL endpoint to UniFiClient in `src/api/client.py`"

```
Use the @spec-task-executor agent to implement task 2.7: "Add stream URL endpoint to UniFiClient in `src/api/client.py`" for the camera-live-view specification and include all the below context.
...
## Task Details
- Task ID: 2.7
- Description: Add stream URL endpoint to UniFiClient in `src/api/client.py`

## Instructions
- Implement ONLY task 2.7: "Add stream URL endpoint to UniFiClient in `src/api/client.py`"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks camera-live-view 2.7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks camera-live-view 2.7 --mode complete
```

# camera-live-view - Task 1.4

Execute task 1.4 for the camera-live-view specification.

## Task Description
Create configuration utility class in `src/utils/config.py`

## Usage
```
/Task:1.4-camera-live-view
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create configuration utility class in `src/utils/config.py`"

```
Use the @spec-task-executor agent to implement task 1.4: "Create configuration utility class in `src/utils/config.py`" for the camera-live-view specification and include all the below context.
...
## Task Details
- Task ID: 1.4
- Description: Create configuration utility class in `src/utils/config.py`

## Instructions
- Implement ONLY task 1.4: "Create configuration utility class in `src/utils/config.py`"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks camera-live-view 1.4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks camera-live-view 1.4 --mode complete
```
